  ...
  HabitsApp._()
      : super(
            ...
            theme: ThemeData(
                ...
                iconTheme: const IconThemeData(color: Colors.orange, opacity: 1),
                inputDecorationTheme: InputDecorationTheme(
                    border: OutlineInputBorder(borderRadius: BorderRadius.circular(16)),
                    focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(16), borderSide: const BorderSide(color: Colors.orange)),
                    isCollapsed: true,
                    isDense: true),
                ...
                textTheme: TextTheme(headline1: GoogleFonts.audiowide(), headline2: GoogleFonts.audiowide()),
